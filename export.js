...
async function download_notify() {
    let response = await axios.get("https://gitee.com/lxk0301/jd_scripts/raw/master/sendNotify.js");
...
async function start() {
    ...
    notify.sendNotify("导出SECRETS",encodeURIComponent(process.env.XMLY_SPEED_COOKIE));
